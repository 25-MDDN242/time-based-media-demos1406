...
The greatest learning curve in this project involved understanding the `translate()` and `rotate()` functions in P5.js—something I'm not yet grasping fully. Despite this, some happy accidents occurred, and I was able to get the tumbleweed animation used to represent minutes looking just how I wanted it.

This project taught me much about pixel art, a stark difference from the art styles I'm used to. Scale was my biggest challenge, particularly with the vulture sprite. Early versions made the vulture appear as large as the cowboy sprite, as if to say a vulture the size of an adult human. I considered passing it off as a condor but even that was far fetched. After several iterations and simplifications, I achieved a vulture design that satisfied me, and I still find it cute.

Several ambitious ideas had to be abandoned due to limitations within p5’s framework. For example, I intended to include an interactive element where hitting the vulture three times triggered the vulture to squawk in annoyance, but p5's rapid iteration structure prevented me from being able to do this.
